    ...
    <div id="wrap">
        ...
        <section id="container">
            <div id="content" class="mainContent">
                <div class="main_noti">
                        <a href="#">SUMMER SALE ~19.09.30</a>
                        <a href="#">OPEN EVENT</a>
                        <a href="#">4월 댓글 이벤트 응모!</a>
                        <a href="#">4월 댓글 이벤트 당첨자 발표!!</a>
                </div>
                <div class="mainimg">
                ...
                <div id="step_area">
                    <div class="bwrap">
                        <div class="setArea">
                            <div class="service">
                              <a href="medicalList.html"><img src="images/img_main01.png" width="120" height="176" alt="로그인"></a>
                            </div>
